...
import { Github, Linkedin, Mail, ArrowRight, Code2, Cpu, GraduationCap, Briefcase, ChevronRight, Terminal } from 'lucide-react';
...
// --- DADOS ---
const career = [
  { role: "Systems Analyst", company: "OSM Consultoria", period: "2025 - Atual", desc: "Implementação de Chatbots com IA (LLMs) e dashboards estratégicos com Python." },
  { role: "Software Developer", company: "Pontype", period: "2025 - Atual", desc: "Desenvolvimento Full Stack (FastAPI/React) de CMS e portais. Foco em arquitetura escalável e Mobile-First." },
  { role: "Software Developer - FullStack", company: "Stefanini", period: "2024 - 2025", desc: "Arquitetura de Microsserviços .NET 8, BFF com NestJS e Microfrontends." },
  { role: "Software Engineer", company: "Impercap", period: "2024 - 2025", desc: "Apps Mobile React Native, deploy em Cloud e backend Azure SQL." },
];
...
const projects = [
  {
    ...
    longDesc: "Plataforma digital para hospedagem e cuidados de pets, desenvolvida com foco em escalabilidade e organização das regras de negócio, garantindo uma estrutura robusta, clara e preparada para crescimento, além de uma experiência confiável para os usuários.",
  ...
  },
  {
    ...
    longDesc: "Aplicativo de agendamento para barbearias com foco em UX, projetado para tornar a marcação de horários rápida e intuitiva. A experiência do usuário prioriza poucos passos, clareza na escolha de serviços, barbeiros e horários, além de facilitar a organização da agenda dos profissionais.",
    tech: ["Figma", "UX/UI", "Design"],
  ...
  },
  {
    ...
    longDesc: "Aplicativo móvel para farmácias, desenvolvido para otimizar a compra de medicamentos e produtos de saúde por meio de uma plataforma moderna, escalável e intuitiva. O sistema integra backend robusto e interfaces bem definidas, garantindo performance, organização dos dados e uma experiência de uso simples e eficiente.",
    ...
    longDesc: "Aplicativo desenvolvido para oferecer suporte técnico a profissionais, centralizando instruções, orientações e informações sobre produtos, com foco em facilitar instalações, manutenções e reduzir erros em campo.",
  ...
  },
  {
    ...
    longDesc: "Painel CMS desenvolvido para jornalistas, permitindo a criação, edição e gerenciamento de conteúdos de forma rápida e organizada, com foco em performance, usabilidade e controle editorial.",
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white selection:bg-accent selection:text-black overflow-x-hidden font-sans relative">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 border-b ${isScrolled ? 'py-4 bg-black/80 backdrop-blur-xl border-zinc-800' : 'py-8 bg-transparent border-transparent'}`}>
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center relative"> {/* Adicionado 'relative' aqui */}
          ...
          <div className="group cursor-pointer flex items-center gap-1 font-mono text-xl font-bold tracking-tighter z-10">
            <span className="text-zinc-600 group-hover:text-accent transition-colors duration-300">&lt;</span>
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-zinc-400 group-hover:to-accent transition-all duration-300">FR</span>
            <span className="text-zinc-600 group-hover:text-accent transition-colors duration-300">/&gt;</span>
          </div>
          ...
          <nav className="hidden md:flex gap-8 text-sm font-medium text-zinc-400 absolute left-1/2 -translate-x-1/2">
            <a href="#about" className="hover:text-white transition hover:scale-105">Sobre</a>
            <a href="#stack" className="hover:text-white transition hover:scale-105">Tech</a>
            <a href="#projects" className="hover:text-white transition hover:scale-105">Cases</a>
          </nav>

          {/* BOTÃO CRIATIVO (Efeito Líquido) */}
          <a href="#contact" className="relative group overflow-hidden px-6 py-2 rounded-full bg-transparent border border-white/20 text-sm font-bold transition-all hover:border-accent hover:shadow-[0_0_20px_rgba(60,213,179,0.3)] z-10">
            <span className="relative z-10 group-hover:text-black transition-colors duration-300">Fale Comigo</span>
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[70vw] h-[70vw] bg-accent/5 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '-5s' }}></div>
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 relative pt-20">
          <motion.div style={{ y: yHero, opacity: opacityHero }} className="flex flex-col items-center">
            ...
            >
              <span className="text-white font-semibold">Software Engineer & Technical Product Manager.</span><br/>
              Não apenas escrevo código. Eu crio sistemas escaláveis e experiências memoráveis que resolvem problemas reais de negócio.
            </motion.p>
            ...
            >
              <a href="#projects" className="group relative px-8 py-4 bg-white text-black font-bold rounded-lg overflow-hidden transition hover:scale-105">
                <span className="relative z-10 flex items-center gap-2">Explorar Projetos <ArrowRight size={18} /></span>
              ...
              <a href="#about" className="px-8 py-4 border border-zinc-700 text-zinc-300 rounded-lg font-bold hover:bg-zinc-900 hover:text-white transition flex items-center gap-2">
                Sobre a Máquina
              </a>
            </motion.div>
          </motion.div>
              ...
              >
                ...
                <ul className="space-y-4">
                  <li className="flex justify-between items-start border-b border-zinc-800 pb-2">
                    <span className="text-sm text-zinc-300">Engenharia de Software</span>
                    <span className="text-xs text-zinc-500 font-mono">UCB (Em andamento)</span>
                  </li>
                  {courses.map((course, i) => (
                    <li key={i} className="flex justify-between items-start border-b border-zinc-800/50 pb-2 last:border-0 hover:pl-2 transition-all">
            ...
            <div className="lg:col-span-7">
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold mb-8 flex items-center gap-4">
                  <Cpu className="text-accent w-10 h-10" /> Trajetória Profissional
                </h2>

                <p className="text-lg text-zinc-400 leading-relaxed mb-12 border-l-2 border-accent/30 pl-6">
                  Minha abordagem combina a precisão técnica da engenharia com a visão estratégica de gerenciamento. Não apenas escrevo código; construo ecossistemas digitais que funcionam.
                </p>
                      ...
                      <div className="bg-zinc-900/20 p-6 rounded-xl border border-zinc-800/50 hover:border-zinc-700 hover:bg-zinc-900/40 transition-all duration-300 transform group-hover:-translate-y-1 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                          <div className="flex flex-col md:flex-row md:items-center justify-between mb-2">
                            <h3 className="text-xl font-bold text-white group-hover:text-accent transition">{job.role}</h3>
                            <span className="text-xs font-mono text-zinc-500 px-2 py-1 bg-black rounded border border-zinc-800">{job.period}</span>
                          </div>
                          <h4 className="text-zinc-400 font-medium mb-3">@ {job.company}</h4>
        ...
        <section id="projects" className="py-20 max-w-7xl mx-auto px-6 relative">
          ...
          >
            <div>
              ...
              <h2 className="text-5xl font-bold text-white">Projetos Recentes</h2>
            </div>
          </motion.div>
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-8 z-20">
                    <div className="mb-4 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                      <div className="flex gap-2">
                        {project.tech.map(t => (
                          <span key={t} className="text-[10px] uppercase font-bold bg-white/10 border border-white/20 text-white px-2 py-1 rounded backdrop-blur-md">{t}</span>
                        ))}
                      </div>
                    </div>

                    <h3 className="text-3xl font-bold text-white mb-2 group-hover:text-accent transition-colors">{project.title}</h3>
                    <p className="text-zinc-400 line-clamp-2 max-w-xl group-hover:text-white transition-colors">{project.desc}</p>
        ...
        <section className="py-32 relative overflow-hidden">
          ...
          <motion.div
            ...
            variants={fadeInUp}
          >
            <h2 className="text-5xl md:text-7xl font-bold mb-8 tracking-tighter">Ready to Deploy?</h2>
            <p className="text-xl text-zinc-400 mb-12">Vamos transformar sua ideia em código de alta performance.</p>

            <a href="mailto:felipe90rcha@hotmail.com" className="inline-flex items-center gap-3 bg-white text-black px-12 py-5 rounded-full text-lg font-bold hover:bg-accent hover:scale-105 transition duration-300 shadow-[0_0_30px_rgba(255,255,255,0.2)]">
